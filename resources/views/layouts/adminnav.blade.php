<nav class="grid w-full grid-cols-3 p-2 mb-4 text-pink-400" style="background: rgba(251, 207, 232, 0.7)">
  ...
  <div class="block col-span-2 text-right">
    <button id="menu_button" class="inline-block px-4 py-1 mx-4 font-sans font-semibold border border-pink-400 rounded-md" onclick="expander('menu_items')">Status Pendaftaran</button>
  </div>
